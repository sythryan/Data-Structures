...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_file_tree_insert_test" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#d42d753d#;
   pragma Export (C, u00001, "file_tree_insert_testB");
   ...
   u00116 : constant Version_32 := 16#d0db88fe#;
   pragma Export (C, u00116, "file_treeB");
   u00117 : constant Version_32 := 16#b5f77d20#;
   pragma Export (C, u00117, "file_treeS");
   u00118 : constant Version_32 := 16#95c03aaa#;
   pragma Export (C, u00118, "system__direct_ioB");
   u00119 : constant Version_32 := 16#e2a2a0d7#;
   pragma Export (C, u00119, "system__direct_ioS");
   u00120 : constant Version_32 := 16#6e3ec6bb#;
   pragma Export (C, u00120, "system__sequential_ioB");
   u00121 : constant Version_32 := 16#f9458332#;
   pragma Export (C, u00121, "system__sequential_ioS");
   u00122 : constant Version_32 := 16#39591e91#;
   pragma Export (C, u00122, "system__concat_2B");
   u00123 : constant Version_32 := 16#967f6238#;
   pragma Export (C, u00123, "system__concat_2S");
   u00124 : constant Version_32 := 16#5ffcea55#;
   pragma Export (C, u00124, "system__random_numbersB");
   u00125 : constant Version_32 := 16#21858c24#;
   pragma Export (C, u00125, "system__random_numbersS");
   u00126 : constant Version_32 := 16#194ccd7b#;
   pragma Export (C, u00126, "system__img_unsB");
   u00127 : constant Version_32 := 16#98baf045#;
   pragma Export (C, u00127, "system__img_unsS");
   u00128 : constant Version_32 := 16#7d397bc7#;
   pragma Export (C, u00128, "system__random_seedB");
   u00129 : constant Version_32 := 16#7e93c81d#;
   pragma Export (C, u00129, "system__random_seedS");
   u00130 : constant Version_32 := 16#8ba0787e#;
   pragma Export (C, u00130, "ada__calendarB");
   u00131 : constant Version_32 := 16#e791e294#;
   pragma Export (C, u00131, "ada__calendarS");
   u00132 : constant Version_32 := 16#3fcdd715#;
   pragma Export (C, u00132, "system__os_primitivesB");
   u00133 : constant Version_32 := 16#dd7e1ced#;
   pragma Export (C, u00133, "system__os_primitivesS");
   u00134 : constant Version_32 := 16#3ead0efd#;
   pragma Export (C, u00134, "system__win32S");
   u00135 : constant Version_32 := 16#aa4baafd#;
