...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_file_tree2" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#9950bf8c#;
   pragma Export (C, u00001, "test_file_tree2B");
   ...
   u00115 : constant Version_32 := 16#d0db88fe#;
   pragma Export (C, u00115, "file_treeB");
   u00116 : constant Version_32 := 16#b5f77d20#;
   pragma Export (C, u00116, "file_treeS");
   u00117 : constant Version_32 := 16#95c03aaa#;
   pragma Export (C, u00117, "system__direct_ioB");
   u00118 : constant Version_32 := 16#e2a2a0d7#;
   pragma Export (C, u00118, "system__direct_ioS");
   u00119 : constant Version_32 := 16#6e3ec6bb#;
   pragma Export (C, u00119, "system__sequential_ioB");
   u00120 : constant Version_32 := 16#f9458332#;
   pragma Export (C, u00120, "system__sequential_ioS");
   u00121 : constant Version_32 := 16#39591e91#;
   pragma Export (C, u00121, "system__concat_2B");
   u00122 : constant Version_32 := 16#967f6238#;
