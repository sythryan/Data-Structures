...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_unbounded_fun" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#5238f937#;
   pragma Export (C, u00001, "unbounded_funB");
   ...
   u00118 : constant Version_32 := 16#193a50a3#;
